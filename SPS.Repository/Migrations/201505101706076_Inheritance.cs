    ...
    public partial class Inheritance : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Id, t.CNPJ })
                .ForeignKey("dbo.Addresses", t => t.Address_PostalCode)
                .ForeignKey("dbo.LocalManagers", t => t.Id)
                .Index(t => t.Id)
                .Index(t => t.Address_PostalCode);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Parkings", t => new { t.Parking_Id, t.Parking_CNPJ })
                .Index(t => new { t.Parking_Id, t.Parking_CNPJ });
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Parkings", "Id", "dbo.LocalManagers");
